            ...
            queue.add(async () => {
                try {
                    ...
                    for (let i = 0; i < steps.length; i++) {
                        ...
                        const result = await executor.execute(rawRow, // Pass raw row to executor (Strategies will handle command sanitization internally if needed)
                        index, stepIndex, resolvedStep, persistentHistory);
