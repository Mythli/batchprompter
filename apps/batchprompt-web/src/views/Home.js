    ...
    <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
        ...
        <form class="space-y-4" hx-encoding="multipart/form-data">
            <div>
                ...
                <textarea name="prompt" class="w-full h-32 p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Describe what you want to scrape or process..." required></textarea>
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Upload Data (CSV/JSON) - Optional</label>
                <input type="file" name="file" accept=".csv,.json" class="block w-full text-sm text-gray-500
            ...
            <div class="flex gap-4">
                <button hx-post="/generate" hx-target="#results" hx-indicator="#loading" class="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition-colors font-medium">
                    Generate Config
                </button>
            </div>
        </form>
