...
export type WebsiteAgentRawConfig = z.infer<typeof WebsiteAgentConfigSchema>;

export interface WebsiteAgentResolvedConfig {
    type: 'website-agent';
    id: string;
...
export class WebsiteAgentPlugin implements Plugin<WebsiteAgentRawConfig, WebsiteAgentResolvedConfig> {
    readonly type = 'website-agent';
    readonly configSchema = WebsiteAgentConfigSchema;
    ...
    parseCLIOptions(options: Record<string, any>, stepIndex: number): WebsiteAgentRawConfig | null {
    ...
    async resolveConfig(
        rawConfig: WebsiteAgentRawConfig,
        row: Record<string, any>,
        inheritedModel: { model: string; temperature?: number; thinkingLevel?: 'low' | 'medium' | 'high' }
    ): Promise<WebsiteAgentResolvedConfig> {
    ...
    async execute(
        config: WebsiteAgentResolvedConfig,
