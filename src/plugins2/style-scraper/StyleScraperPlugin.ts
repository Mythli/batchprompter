...
export const StyleScraperConfigSchema = z.object({
...
export type StyleScraperRawConfig = z.infer<typeof StyleScraperConfigSchema>;

export interface StyleScraperResolvedConfig {
    type: 'style-scraper';
    id: string;
...
export class StyleScraperPlugin implements Plugin<StyleScraperRawConfig, StyleScraperResolvedConfig> {
    readonly type = 'style-scraper';
    readonly configSchema = StyleScraperConfigSchema;
    ...
    parseCLIOptions(options: Record<string, any>, stepIndex: number): StyleScraperRawConfig | null {
    ...
    async resolveConfig(
        rawConfig: StyleScraperRawConfig,
        row: Record<string, any>,
        inheritedModel: { model: string; temperature?: number; thinkingLevel?: 'low' | 'medium' | 'high' }
    ): Promise<StyleScraperResolvedConfig> {
    ...
    async execute(
        config: StyleScraperResolvedConfig,
