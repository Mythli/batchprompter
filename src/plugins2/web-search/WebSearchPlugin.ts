...
export type WebSearchRawConfig = z.infer<typeof WebSearchConfigSchema>;
...
export class WebSearchPlugin implements Plugin<WebSearchRawConfig, WebSearchResolvedConfig> {
    readonly type = 'web-search';
    readonly configSchema = WebSearchConfigSchema;
    ...
    parseCLIOptions(options: Record<string, any>, stepIndex: number): WebSearchRawConfig | null {
