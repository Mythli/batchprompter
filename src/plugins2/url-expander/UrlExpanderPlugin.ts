...
export type UrlExpanderRawConfig = z.infer<typeof UrlExpanderConfigSchema>;
...
export class UrlExpanderPlugin implements Plugin<UrlExpanderRawConfig, UrlExpanderResolvedConfig> {
    ...
    parseCLIOptions(options: Record<string, any>, stepIndex: number): UrlExpanderRawConfig | null {
    ...
    async resolveConfig(
        rawConfig: UrlExpanderRawConfig,
