...
async function handleAiRequest(url, init, originalFetch) {
...
async function handleGeneralFetch(url, init, originalFetch) {
    const urlString = typeof url === 'string' ? url : url.toString();
...
export function createLoggingFetcher(fetcher) {
...
//# sourceMappingURL=createLoggingFetcher.js.map