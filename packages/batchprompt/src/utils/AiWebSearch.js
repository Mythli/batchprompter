...
export class AiWebSearch {
    ...
    constructor(webSearch, queryLlm, selector, compressLlm) {
        this.webSearch = webSearch;
        this.queryLlm = queryLlm;
        this.selector = selector;
        this.compressLlm = compressLlm;
    }
    async process(row, config) {
        ...
        if (finalSelection.length === 0)
            return { contentParts: [{ type: 'text', text: "No results found." }], data: [] };
...
//# sourceMappingURL=AiWebSearch.js.map