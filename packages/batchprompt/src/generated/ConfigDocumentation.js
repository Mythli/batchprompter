...
examples/01-rag-imagegen/config.json
\`\`\`
{
  "globals": {
...
examples/02-lead-gen/config-1-find.json
\`\`\`
{
  "globals": {
...
examples/02-lead-gen/config-2-enrich.json
\`\`\`
{
  "data": {},
  "globals": {
...
examples/03-seo-rank/config.json
\`\`\`
{
  "data": {
    "limit": 10
...
examples/04-describe-website-css/config.json
\`\`\`
{
  "globals": {
...
examples/05-logo-downloader/README.md
\`\`\`
...
examples/05-logo-downloader/config.json
\`\`\`
{
  "data": {
    "format": "csv"
...
examples/05-simple-chain/config.json
\`\`\`
{
  "globals": {
    "model": "google/gemini-3-flash-preview",
...
`;
//# sourceMappingURL=ConfigDocumentation.js.map