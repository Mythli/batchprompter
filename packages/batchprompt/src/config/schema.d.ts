import { z } from 'zod';
import { PromptDefSchema, ModelConfigSchema, OutputConfigSchema } from './common.js';
export { PromptDefSchema, ModelConfigSchema, OutputConfigSchema };
export declare const UrlExpanderSchema: z.ZodObject<{
...
export declare const PreprocessorSchema: z.ZodDiscriminatedUnion<"type", [z.ZodObject<{
    type: z.ZodLiteral<"url-expander">;
    mode: z.ZodDefault<z.ZodEnum<["fetch", "puppeteer"]>>;
    maxChars: z.ZodDefault<z.ZodNumber>;
}, "strip", z.ZodTypeAny, {
...
export declare const StepConfigSchema: z.ZodObject<{
    ...
    skipCandidateCommand?: boolean | undefined;
    judge?: {
        system?: string | {
            text?: string | undefined;
            file?: string | undefined;
...
export declare const LooseStepConfigSchema: z.ZodObject<{
    prompt: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodObject<{
        file: z.ZodOptional<z.ZodString>;
        text: z.ZodOptional<z.ZodString>;
        parts: z.ZodOptional<z.ZodArray<z.ZodObject<{
    ...
    schema: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodEffects<z.ZodRecord<z.ZodString, z.ZodAny>, Record<string, any>, Record<string, any>>]>>;
    plugins: z.ZodDefault<z.ZodArray<z.ZodDiscriminatedUnion<"type", [z.ZodObject<{
        type: z.ZodLiteral<"web-search">;
        id: z.ZodOptional<z.ZodString>;
        output: z.ZodDefault<z.ZodObject<{
    ...
    candidates: number;
    skipCandidateCommand: boolean;
    schema?: string | Record<string, any> | undefined;
    feedback?: {
        loops: number;
        system?: string | {
            text?: string | undefined;
...
export declare const GlobalsConfigSchema: z.ZodObject<{
...
export declare const LoosePipelineConfigSchema: z.ZodObject<{
    data: z.ZodDefault<z.ZodOptional<z.ZodObject<{
        format: z.ZodDefault<z.ZodEnum<["csv", "json", "auto"]>>;
        offset: z.ZodOptional<z.ZodNumber>;
        limit: z.ZodOptional<z.ZodNumber>;
