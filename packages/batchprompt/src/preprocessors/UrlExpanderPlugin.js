...
export class UrlExpanderPlugin {
    registry;
    name = 'url-expander';
    ...
    registerStep(program, stepIndex) {
    ...
    normalize(options, stepIndex, globalConfig) {
    ...
    async process(parts, context, config) {
...
//# sourceMappingURL=UrlExpanderPlugin.js.map