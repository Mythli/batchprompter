...
// =============================================================================
export class WebSearchPluginV2 {
    type = 'web-search';
    configSchema = WebSearchConfigSchemaV2;
    cliOptions = [
        // Query model options
    ...
    async resolveConfig(rawConfig, row, inheritedModel, contentResolver) {
        ...
        return {
            ...
            compressModel: await resolvePrompt(rawConfig.compressPrompt, rawConfig.compressModel, rawConfig.compressTemperature, rawConfig.compressThinkingLevel),
    ...
    async execute(config, context) {
        ...
        const packets = result.data.map(item => {
...
//# sourceMappingURL=WebSearchPluginV2.js.map