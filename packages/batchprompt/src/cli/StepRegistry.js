...
export class StepRegistry {
    static registerStepArgs(program, registry) {
        // --- Config File ---
    ...
    static async parseConfig(fileConfig, options, positionalArgs, registry, contentResolver) {
