...
This example demonstrates how to use the `logo-scraper` plugin to extract brand logos and colors from a website.
...
4.  **Output**: The best logos are saved to disk, and the analysis (colors, scores) is saved as JSON.
