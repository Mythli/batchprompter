...
npx tsx src/index.ts generate examples/10-image/data.csv examples/10-image/prompt-6-dashboard \
  ...
  --image-search-prompt-1 "Find a high-quality, bright, atmospheric photo representing {{industry}} in a German setting. Focus on the actual work environment or typical setting for {{industry}}. No text overlay." \
  --image-select-prompt-1 "Select the best image that represents {{industry}}. It should be bright, high-quality photography, and suitable for use as a background. It should show the specific environment of {{industry}}." \
  --candidates-1 3 \
